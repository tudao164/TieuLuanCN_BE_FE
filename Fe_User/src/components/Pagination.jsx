  ...
  return (
    <div className="flex justify-center items-center gap-2 mt-6">
      ...
      <button
        ...
        className={`px-3 py-2 border rounded-lg transition-colors ${!hasPrev || currentPage <= 1
      ...
      {pageNumbers.map((number, index) => (
        number === '...' ? (
          ...
          <button
            ...
            className={`px-3 py-2 border rounded-lg transition-colors cursor-pointer ${currentPage === number
      ...
      <button
        ...
        className={`px-3 py-2 border rounded-lg transition-colors ${!hasNext || currentPage >= totalPages
            ? 'opacity-50 cursor-not-allowed bg-gray-100 text-gray-400'
            : 'hover:bg-gray-50 bg-white text-gray-700 cursor-pointer'
          }`}
      >
